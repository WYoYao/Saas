package com.sagacloud.saas.startup;
...
import com.sagacloud.saas.dao.DBAgent;
                ...
                public void run(){
                    ...
                    while(true){
                        try {
                            ...
                            ObjWoRelCache.synCache();
                            ObjWoRemindConfigCache.synCache();
                            InfoPointCache.synCache();
                            DictionaryCache.synCache();
                            ProjectPersonCache.synCache();
                        } catch (Exception e) {
                            e.printStackTrace();
                            log.error(e);
                        }finally {
