...
startServer.prototype.Start = function () {
    ...
    global.commonLibUrl = _config.commonLibUrl;
    global.uploadPath = uploadPath;

    var mapFilePath = this.path.join(baseDirname, 'dataModelMap');
    global._mapConfig = require(mapFilePath) || {};
    ...
    require('./startAfter')(app, isLogin, routes);
};
